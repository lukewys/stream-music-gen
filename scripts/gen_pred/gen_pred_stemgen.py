...
@bind
def main(
    save_dir: str = "online-stem-gen/model_predictions/model_predictions_stemgen_val_2025_03_14",
    model_path: str = "online-stem-gen/logs/stemgen_base/step=100000.ckpt",
