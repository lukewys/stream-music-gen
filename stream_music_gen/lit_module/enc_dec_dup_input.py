...
class LitEncoderDecoderDupInput(BaseLightningModel):
    def __init__(
        self,
        compile: bool = True,
        ...
        super(LitEncoderDecoderDupInput, self).__init__()
        ...
        self.model = EncoderDecoderTransformerMultiOut(
            ...
            duplicate_input_in_dec=True,
            output_emb_dim=tokenizer.emb_dim,  # use the same embedding size as input
        )
