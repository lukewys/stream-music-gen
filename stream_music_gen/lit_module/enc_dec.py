...
from stream_music_gen.models import EncoderDecoderTransformer
...
class LitEncoderDecoder(BaseLightningModel):
    def __init__(
        ...
        self.model = EncoderDecoderTransformer(
            ...
            enc_max_seq_len=self.max_gen_seq_len + 2,
            dec_max_seq_len=self.max_gen_seq_len + 2,
    ...
    def training_step(self, batch, batch_idx):
        ...
        enc_inputs, dec_inputs, targets, enc_inputs_mask, dec_inputs_mask = (
